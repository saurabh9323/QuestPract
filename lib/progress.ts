...
export type DayProgress = {steps:string[];answers:Record<string,Answer>;notes:string;updatedAt:string;completedAt?:string;reviewDue?:string;reviewLevel:number;lastReviewedAt?:string;recall?:string};
export type Todo = {id:string;text:string;done:boolean;day:number;createdAt:string;updatedAt:string};
export type Progress = {version:1;startDate:string;days:Record<string,DayProgress>;todos:Todo[];updatedAt:string;practice?:Record<string,Practice>};
