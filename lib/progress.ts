...
export type Progress = {version:1;startDate:string;days:Record<string,DayProgress>;todos:Todo[];updatedAt:string;practice?:Record<string,Practice>;planning?:Planning;communication?:Record<string,CommunicationLog>;enrollment?:Enrollment;profile?:Profile};
